...
// New-design button recipes (match BookingCalendar / HomeView: tween scale,
// no spring). Secondary = panel surface, primary = accent.
const btnBase = 'text-sm font-medium rounded-xl transition-all duration-[120ms] ease-out hover:scale-[1.02] active:scale-[0.95] disabled:opacity-50 disabled:hover:scale-100 disabled:active:scale-100'
const btnPanel = { background: 'var(--panel)', color: 'var(--text)', border: '1px solid var(--edge)', boxShadow: 'var(--card-shadow)' } as const
const btnAccent = { background: 'var(--accent)', color: 'var(--selected-text)' } as const
const inputStyle = { background: 'var(--inset)', color: 'var(--text)', border: '1px solid var(--hairline)' } as const
    ...
    <section className="pt-12 pb-8">
      ...
      >
        ...
        >
          ...
          <SquircleCard radius={20} className="p-5 sm:p-8">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  style={{ width: '48px', height: '24px', background: theme === 'dark' ? 'var(--inset)' : 'var(--accent)', border: '1px solid var(--hairline)' }}
                >
                  <span
                    className={`absolute rounded-full transition-transform duration-200 shadow-sm ${theme === 'dark' ? 'toggle-handle-off' : ''}`}
                    style={{
                      width: '20px', height: '20px', top: '1px', left: '1px',
