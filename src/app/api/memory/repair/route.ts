...
export async function POST(request: NextRequest) {
  ...
  const system =
    ...
    'Rules: ' +
    '1) If the learner\'s English is already correct and natural for SPOKEN conversation, set "ok" to true and return it UNCHANGED as "corrected" (you may fix only capitalization or punctuation). Do NOT paraphrase, reword, shorten, expand, or "improve" a sentence that is already fine. ' +
    ...
    '4) Set "ok" to false ONLY when there is a real grammar error, a wrong word, or it is genuinely unnatural or unclear (not merely short or incomplete). Then "corrected" is the SMALLEST fix that keeps their meaning and as much of their original wording as possible. ' +
