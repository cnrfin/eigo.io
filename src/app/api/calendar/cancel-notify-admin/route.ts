...
import { sendAdminBatchCancellationNotification } from '@/lib/email'

// POST /api/calendar/cancel-notify-admin
// Sends a single admin email summarising multiple cancellations
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    await sendAdminBatchCancellationNotification({
      studentName,
      studentEmail,
      lessons,
    })
