...
export default function InfoSection() {
  ...
  const rows: RowData[] = [
    ...
    { label: t('litePrice'), value: `${t('litePriceValue')}\n${t('litePriceDetail')}`, note: t('litePriceTrialNote') },
    { label: t('standardPrice'), value: `${t('standardPriceValue')}\n${t('standardPriceDetail')}`, note: t('standardPriceTrialNote') },
    { label: t('trialNote'), value: t('trialNoteValue') },
