...
export const translations = {
  ja: {
    ...
    litePriceValue: '¥10,000/月  or  ¥100,000/年',
    litePriceDetail: '月120分（週30分）',
    litePriceTrialNote: '体験後48時間以内: ¥6,000/月 or ¥66,000/年',
    standardPrice: 'Student Standard',
    standardPriceValue: '¥20,000/月  or  ¥200,000/年',
    standardPriceDetail: '月240分（週60分）',
    standardPriceTrialNote: '体験後48時間以内: ¥12,000/月 or ¥132,000/年',
    trialNote: '体験レッスン',
    trialNoteValue: '無料15分 — 体験後48時間以内の入会で最大45%オフ',
    billingNote: 'お支払い',
  ...
  en: {
    ...
    litePrice: 'Student Lite',
    litePriceValue: '¥10,000/mo  or  ¥100,000/yr',
    litePriceDetail: '120 min/month (30 min/week)',
    litePriceTrialNote: 'With trial: ¥6,000/mo or ¥66,000/yr',
    standardPrice: 'Student Standard',
    standardPriceValue: '¥20,000/mo  or  ¥200,000/yr',
    standardPriceDetail: '240 min/month (60 min/week)',
    standardPriceTrialNote: 'With trial: ¥12,000/mo or ¥132,000/yr',
    trialNote: 'Trial lesson',
    trialNoteValue: 'Free 15 min — up to 45% off when you join within 48h',
    billingNote: 'Billing',
