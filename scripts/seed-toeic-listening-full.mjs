...
// ────────────────────────────────────────────────────────────────────────────
const PART2 = [
  { q: ['w1', 'Where is the marketing department?'], r: [['At nine o’clock.', false], ['Yes, twice a week.', false], ['On the fourth floor.', true]] },
  ...
  { q: ['w1', 'How do I get reimbursed for the taxi fare?'], r: [['Submit the receipt online.', true], ['About twenty minutes.', false], ['He went by train.', false]] },
  ...
  { q: ['w2', 'Haven’t you met the new branch manager yet?'], r: [['The main branch downtown.', false], ['A management seminar.', false], ['Yes, on Monday.', true]] },
  ...
  { q: ['w1', 'The client meeting went well, didn’t it?'], r: [['At the client’s office.', false], ['A new contract.', false], ['Better than expected.', true]] },
  ...
  { q: ['w1', 'Should we order more paper, or do we have enough?'], r: [['Double-sided, please.', false], ['By Friday at the latest.', false], ['The supply cabinet is full.', true]] },
  ...
  { q: ['m1', 'When will the renovation be finished?'], r: [['The lobby and the café.', false], ['A construction company.', false], ['By the end of the month.', true]] },
  ...
  { q: ['m2', 'Could I see the lunch menu, please?'], r: [['Table for two.', false], ['The kitchen closes at three.', false], ['Of course, here you are.', true]] },
  ...
  { q: ['w1', 'You’ve backed up the customer database, right?'], r: [['About five thousand records.', false], ['The IT department is upstairs.', false], ['Yes, it runs automatically every night.', true]] },
]
